            ...
            <ContainerIframe>
              ...
              {infoPremiumSite ? (
                ...
                >
                  ...
                  >
                    אתר זה בעל עיצוב ברמה ובאיכות הגבוה ביותר שיש, עם מגוון רחב
                    של אנימציות ותמונות. אתר זה כולל בתוכו תמונות רקע באנימצייה
                    שמתחלפות באופן אוטומטי בדף הבית, בנוסף קיימת גם גלריית
                    תמונות וניתנת האפשרות לעלות עד 20 תמונות לגלרייה, בנוסף
                    הרוכשים את האתר הפרימיום מקבלים ברקוד מתנה לגישה מהירה לאתר.
                  </p>
